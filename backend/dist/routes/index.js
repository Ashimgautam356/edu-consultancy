...
const getGroupChat_1 = __importDefault(require("../controllers/getGroupChat"));
const authenticate_1 = require("../middleware/authenticate");
const oneChat_1 = __importDefault(require("../controllers/oneChat"));
...
exports.router.get("/message/:chatId", getOldMessage_1.default);
exports.router.get("/country", getCountry_1.default);
exports.router.get("/chat/:specificChat", oneChat_1.default);
exports.router.use(authenticate_1.auth);
exports.router.get("/chat", getGroupChat_1.default);
